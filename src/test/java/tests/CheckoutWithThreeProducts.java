...
public class CheckoutWithThreeProducts extends GenericTest {
	...
	public void testUserIsAbleToPlaceOrderWithThreeProducts() {
		...
		CheckoutComplete checkout = openLoginPage().loginAs("standard_user", "secret_sauce").addProductToCart(
				"Test.allTheThings() T-Shirt (Red)", "Sauce Labs Onesie", "Sauce Labs Bike Light").header.openCart()
